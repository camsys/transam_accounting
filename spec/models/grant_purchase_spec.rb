...
RSpec.describe GrantPurchase, :type => :model do
  ...
  it '#allowable_params' do
    expect(GrantPurchase.allowable_params).to eq([:id, :asset_id, :global_sourceable, :sourceable_type, :sourceable_id, :other_sourceable, :pcnt_purchase_cost, :amount, :expense_tag, :fain, :_destroy])
  end
